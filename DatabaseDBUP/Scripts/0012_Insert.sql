...
GO
INSERT [dbo].[Person] ([id], [personTypeId], [clinicId], [practitionerId], [firstName], [lastName], [phoneNo], [email], [passwordHash], [salt], [address], [zipCode]) VALUES (2, 2, 1, NULL, N'admin', N'admin', N'12345678', N'admin@admin.dk', N'f3m8fDJnwal5W7NCBsr4NYocMbN1VMSNWFOY83c65XDTvE+W4pXHxPi1fdGZqLYRpha+susiJnBIP9IFpZjP0A==', N'', NULL, NULL)
GO
INSERT [dbo].[Person] ([id], [personTypeId], [clinicId], [practitionerId], [firstName], [lastName], [phoneNo], [email], [passwordHash], [salt], [address], [zipCode]) VALUES (1, 1, 1, 2, N'Magnus', N'Munk', N'50718449', N'mail@mail.com', N'vagRJq/iNcLUIVJol234+TK+MJR6QJ4rlbDqJpn/C2J5BZuPq3jIyHUqSqDG/FUGQWdS0pvVDwnnhYMXcl/1uQ==', N'', N'vejen 2', N'7470')
GO
